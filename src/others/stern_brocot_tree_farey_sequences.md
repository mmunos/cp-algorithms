...
<div style="text-align: center;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/3/37/SternBrocotTree.svg" alt="Stern-Brocot tree">
</div>
...
This approach clearly works if we already know $\frac{p}{q}$. If we do not know it in advance, the approach still has a guaranteed $O(\log (p+q))$ runtime, as explained [here](https://arxiv.org/abs/2511.12315) (Proposition 1).
